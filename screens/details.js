...
import {View, Text, StyleSheet, ScrollView,Picker,Image,Dimensions, TouchableOpacity} from 'react-native';
...
class DetailsScreen extends React.Component {
    ...
    componentDidMount(){
        ...
        if(Object.keys(this.props.data.productdetails).length > 0){
           ...
           if(this.props.data.productdetails.sizes != null && this.props.data.productdetails.sizes != ''){
            let sizes = this.props.data.productdetails.sizes.split(";");
            this.setState({sizes:sizes});
           }
           
           //console.error(this.props.data.productdetails.sizes);
    ...
    addproduct = async () =>{
        let cart = [];
        if(this.state.size == ''){
            this.setState({isSize:!this.state.isSize,msg:'Kindly select the size you want'});
            return false;
        }
            ...
            <View style = {styles.container}>
              ...
              <ScrollView showsVerticalScrollIndicator = {false}>  
                <View>
                    ...
                    <View>
                    <Modal isVisible={this.state.isSize}>
                    <View style={{backgroundColor:'#fff',width:'98%',height:300,marginRight:0,alignSelf:'center' }}>
                        ...
                        <View style={{flexDirection:'row',padding:10,alignSelf:'center',marginTop:15}}>
                            ...
                            <TouchableOpacity onPress = {()=>this.setState({isSize:false})}>
                    ...
                    <View style={{backgroundColor:'#fff',width:'98%',height:300,marginRight:0,alignSelf:'center' }}>
                        ...
                        <View style={{flexDirection:'row',padding:10,alignSelf:'center',marginTop:15}}>
                            <TouchableOpacity onPress = {() => this.props.navigation.goBack()}>
                                <Text onPress = {this.action} style={{color:'#BA1717',fontSize:13,borderWidth:2,borderRadius:5,borderColor:'#BA1717',padding:12,marginRight:5,fontFamily:'Montserrat-Bold'}}>Continue Shopping</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress = {this.goCart}>
                                <Text style={{color:'#fff',fontSize:13,borderWidth:1,borderRadius:5,borderColor:'#BA1717',padding:12,marginRight:5,backgroundColor:'#BA1717',fontFamily:'Montserrat-Bold'}}>Go to Cart</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    </Modal> 
                    ...
                    <View style={{flexDirection:'row', alignSelf:'center',marginTop:7}}>
                        {
                            ...
                            (<Octicons key={img+'1'} value = {img+'1'} name="primitive-dot" size={15} color="#BA1717" style={{width:'6%',marginTop:3,opacity:1}}></Octicons>):      
                            (<Octicons key={img+'1'} value = {img+'1'} name="primitive-dot" size={15} color="#BA1717" style={{width:'6%',marginTop:3,opacity:0.3}}></Octicons>)
                            )
                        }  
                      
                    </View>
                    <View style={{borderWidth:1,borderColor:'#c1c1c1'}}>
                    <Picker
                    ...
                    <View style={{flexDirection:'row', marginTop:15,borderBottomWidth:1,borderBottomColor:'#c1c1c1',padding:15,paddingLeft:0,paddingRight:0}}>
                        ...
                        }
                        {
                            ...
                            <IonIcon onPress = {() => this.love(this.props.data.productdetails)} name="ios-heart" size={20} color="#BA1717" style={{position:'relative',textAlign:'right',marginRight:8}}></IonIcon>      
                        }
                    </View>
                    </View>
              ...
              <View style={{flex:1}}>
                   <View>
                    ...
                    <View style={{width:'100%'}}>
                        <Card
                        containerStyle={{width:'100%',padding:4,borderRadius:10,marginStart:0,backgroundColor:'#BA1717',borderColor:'#BA1717'}}
                        >
