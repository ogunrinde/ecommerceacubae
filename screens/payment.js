               ...
               <Modal isVisible={this.state.modalVisible}>
                <View style={{backgroundColor:'#fff',width:'98%',height:300,marginRight:0,alignSelf:'center' }}>
                    ...
                    <View style={{flexDirection:'row',padding:10,alignSelf:'center',marginTop:15}}>
                        ...
                        <TouchableOpacity>
                            <Text onPress = {this.action} style={{color:'#fff',fontSize:13,borderWidth:1,borderRadius:5,borderColor:'#BA1717',padding:12,marginRight:5,backgroundColor:'#BA1717',fontFamily:'Montserrat-Bold'}}>View Order</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                </Modal>
               <View style={{marginTop:16}}>
                   ...
                   <View style={{borderColor:'#7DD148',borderWidth:1,padding:15,borderRadius:10}}>
                            ...
                            </View>
                       {
                        ...
                        <View style={{flexDirection:'row',marginTop:5,padding:10,marginStart:10}}>
                            ...
                            <Text style={{width:'50%',fontFamily:'Montserrat-Regular',textAlign:'center',marginEnd:5,color:'#BA1717'}}>{currencyFormatter.format(0, { code: 'NGN' })}</Text>
                        </View>
                        <View style={{flexDirection:'row',marginTop:0,padding:10,marginStart:10}}>
                            ...
                            <Text style={{width:'50%',fontFamily:'Montserrat-Bold',textAlign:'center',marginEnd:5,color:'#BA1717'}}>{currencyFormatter.format((parseFloat(this.props.data.total_price) - parseFloat(this.props.data.gifts.certificate)), { code: 'NGN' })}</Text>
                        </View>
                   ...
                   */}

                            {
                                ...
                                <TouchableOpacity onPress ={this.paynow}  style={{marginTop:20,marginBottom:20,backgroundColor:'#BA1717',borderRadius:2,padding:13}}>
                                   <Text  style={{color:'#fff',alignSelf:'center', fontFamily:'Montserrat-SemiBold'}}>Pay Now</Text>
                                </TouchableOpacity>
                            }
                            {
                                this.state.isFetching == true &&
                                <TouchableOpacity  style={{marginTop:20,marginBottom:20,backgroundColor:'#BA1717',borderRadius:2,padding:13}}>
