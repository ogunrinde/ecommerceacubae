            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
              ...
              <View>
                ...
                <View>
                    ...
                    <TouchableOpacity style={{backgroundColor:'#BA1717',padding:10,marginTop:20}}>
                    ...
                    <Card containerStyle={{backgroundColor:'#fff',width:'100%', marginStart:0}}>
                        <View>
                            ...
                            <View style={{flexDirection:'row',marginTop:7,borderBottomColor:'#E6E6E6',borderBottomWidth:1,paddingBottom:11}}>
                                ...
                                <Text style={{marginRight:'auto',color:'#BA1717',width:'40%',textAlign:'right',fontSize:14,marginTop:2,fontFamily:'Montserrat-Regular'}}>NGN 0</Text>
                            </View>
                            <View style={{flexDirection:'row',marginTop:7,borderBottomColor:'#E6E6E6',borderBottomWidth:1,paddingBottom:11}}>
                                <Text style={{fontSize:14,color:'#4d4d4d',width:'60%',fontFamily:'Montserrat-Regular'}}>Total</Text>
                                <Text style={{marginRight:'auto',color:'#BA1717',width:'40%',fontSize:14,marginTop:2,textAlign:'right',fontFamily:'Montserrat-Regular'}}>{currencyFormatter.format(this.state.total_price, { code: 'NGN' })}</Text>
                            </View>
