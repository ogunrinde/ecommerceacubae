...
class CardDetails extends React.Component {
    ...
    paynow = () =>{
        ...
        this.setState({isFetching:true});
        RNPaystack.init({ publicKey: 'pk_live_66d7e07bdd94054600bafbd36dcab9980b822a05' });
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                <View>
                    ...
                    <Text style={{color:'#000',fontSize:15,fontFamily:'Montserrat-Regular',textAlign:'center',marginTop:20}}>Thank you for shopping with us!</Text>
                        ...
                        <Text style={{color:'#000',fontSize:15,fontFamily:'Montserrat-Regular',textAlign:'center',marginTop:20}}>Your Order <Text style={{color:'#BA1717'}}>{this.props.data.orderid.orders_id}</Text> was placed successfully</Text>        
                        <View style={{flexDirection:'row',padding:10,alignSelf:'center',marginTop:15}}>
                            <TouchableOpacity>
                                <Text onPress = {() => this.props.navigation.navigate('home')} style={{color:'#BA1717',fontSize:13,borderWidth:2,borderRadius:5,borderColor:'#BA1717',padding:12,marginRight:5,fontFamily:'Montserrat-Bold'}}>Continue Shopping</Text>
                            </TouchableOpacity>
                            <TouchableOpacity>
