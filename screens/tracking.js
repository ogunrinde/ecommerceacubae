                ...
                <View>
                    ...
                    <View style={{marginTop:20}}>
                        <View style={{padding:10,flexDirection:'row',alignSelf:'center',width:'100%'}}>
                          ...
                          <IonIcon name="md-checkmark-circle" size={36} color="#BA1717" style={{width:'100%',alignSelf:'center', marginTop:12}}></IonIcon>
                          </View>
                          <View style={{width:'35%',margin:0}}>
                          <View style={{borderBottomColor:'#BA1717',marginStart:-5, borderBottomWidth:3,marginTop:30}}></View>
                          </View>
                          <View style={{width:'10%'}}>
                          {
                          ...
                          {
                              this.state.status != 'Shipped' && this.state.status != 'Delivered' &&
                              <Octicons name="primitive-dot" size={56} color="#BA1717" style={{marginStart:-5, alignSelf:'center',marginTop:3}}></Octicons>

                          }    
                          </View>
                          <View style={{width:'35%'}}>
                          <View style={{borderBottomColor:'#BA1717', borderBottomWidth:3,marginTop:30,marginStart:-5}}></View>
                          </View>
                          <View style={{width:'10%'}}>
                              {
